  ...
  <body>
    ...
    <div class="content mt20">
      <div class="content_nav1">
        <div class="dh">
          <p>我的位置：<a href="#">摇号公示</a>&nbsp;&gt;&nbsp;<a href="#"> 珺悦台 </a></p>
        </div>
        <div class="nav_2_dh" style="margin-top: 10px"><h3>基本信息</h3></div>
        <div class="info">
          <dl class="lbox">
            <dd><strong>开发公司：</strong>合肥和颂房地产开发有限公司</dd>
            <dd><strong>所在区域：</strong>包河区</dd>
            <dd><strong>供应住房总数：</strong>88套</dd>
            <dd><strong>刚需供应数：</strong>27套</dd>
            <dd><strong>项目名称：</strong>珺悦台</dd>
            <dd><strong>联系电话：</strong>0551-62198888、13515608535</dd>
            <dd><strong>售楼部地址：</strong>包河区北京路与乌鲁木齐路交汇处</dd>
          </dl>

          <dl class="lbox" style="text-align: center">
            <img src="/Content/images/float_bottom.jpg" style="width: 150px" />
            <br />
                ...
                <tr>
                  <td>
                    <div class="beihui mgb11" style="height: 80px" title="详细信息点击进入">
                      <a
                        href="/details/HOwDQM2Y6VPTjkfZzKMjdYgmpPT9SUBtyl9NZZO4oHQXHR14DakOfSR6IY6HyMw0QbAM_gRw2BZDK019WcX8eWuG3hnOX3hdunTcUlBpyCMzcNfPLPyapcImrf8ne5TEK39-5ugdinws0gfi6uQGNXGa1gNyfGWmmJxVPVK836s="
                        target="_blank"
                      >
                        <ul>
                          <li><span>预售许可证号：20230090,楼幢：G2幢</span></li>
                        </ul>
                      </a>
                    </div>
                  </td>
