...
<html>
  <head>
    ...
    <title>G2幢 -- 珺悦台 -- 合肥市房产市场信息平台</title>
  ...
  <body>
    ...
    <div class="content mt20">
      <div class="content_nav1">
        <div class="dh">
          <p>我的位置：<a href="/">商品房备案</a>&nbsp;&gt;&nbsp;<a href="#">珺悦台</a>&nbsp;&gt;&nbsp;G2幢</p>
        </div>
        <div class="content_zixun">
          <span>栋号：G2幢</span><span>预售许可证号码：20230090</span><span>建筑结构：钢筋混凝土结构</span>
        </div>
        ...
        <div class="content_xiangx">
          <div class="content_xiangx_bt"><p>幢号：G2幢 许可证详细信息</p></div>
          <ul>
            <li>
              <p>许可证号：<span>20230090</span></p>
              <p>地上层数：<span>23层</span>&nbsp;&nbsp;地下层数：<span>1层</span></p>
            </li>
            <li class="rbg_1">
              <p>土地使用权证：<span>皖（2022）合肥市不动产权第1238096号</span></p>
              <p>套数：<span>88套</span></p>
            </li>
            <li>
              <p>规划许可证：<span>建字第340111202200741号</span></p>
              <p>预售许可面积：<span>10164.88 ㎡</span></p>
            </li>
            <li class="rbg_1">
              <p>建筑结构：<span>钢筋混凝土结构</span></p>
              <p>网上销售总面积：<span>10164.88 ㎡</span></p>
            </li>
            <li>
              <p>用途：<span>住宅</span></p>
              <p>销售电话：<span>0551-62198888</span></p>
            </li>
            <li class="rbg_1">
              <p>设计单位：<span title=""></span></p>
              <p>代理销售企业：<span></span></p>
            </li>
            <li>
              <p>竣工日期：<span>2024/12/30</span></p>
              <p>交付日期：<span>2025/6/30</span></p>
            </li>
          </ul>
        </div>
      </div>
